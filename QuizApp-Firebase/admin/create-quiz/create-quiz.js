...
const addQuestion = () => {
    if (!questionText.value || !correctAnswer.value || !option1.value || !option2.value || !option3.value || !option4.value) {
...
const createQuizHandler = () => {
    ...
    if (!quizTitle.value || !quizCategory.value || !quizLabel.value || questions.length <= 0) {
